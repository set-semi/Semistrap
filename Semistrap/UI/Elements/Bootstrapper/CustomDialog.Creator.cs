...
namespace Semistrap.UI.Elements.Bootstrapper
{
    public partial class CustomDialog
    {
        ...
        {
            ["SemistrapCustomBootstrapper"] = HandleXmlElement_SemistrapCustomBootstrapper_Fake,
        ...
        private static void AssertThemeVersion(string? versionStr)
        {
            if (string.IsNullOrEmpty(versionStr))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotSet", "SemistrapCustomBootstrapper");

            if (!uint.TryParse(versionStr, out uint version))
                throw new CustomThemeException("CustomTheme.Errors.VersionNotNumber", "SemistrapCustomBootstrapper");
            ...
            switch (version)
            {
                case Version:
                    break;
                case 0:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotSupported", "SemistrapCustomBootstrapper", version);
                default:
                    throw new CustomThemeException("CustomTheme.Errors.VersionNotRecognised", "SemistrapCustomBootstrapper", version);
            }
        }
        ...
        private void HandleXmlBase(XElement xml)
        {
            ...
            if (xml.Name != "SemistrapCustomBootstrapper")
                throw new CustomThemeException("CustomTheme.Errors.InvalidRoot", "SemistrapCustomBootstrapper");
            ...
            HandleXmlElement_SemistrapCustomBootstrapper(this, xml);
