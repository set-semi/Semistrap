...
{
    public class SemistrapViewModel : NotifyPropertyChangedViewModel
    {
        ...
        private void ExportData()
        {
            ...
            { 
                FileName = $"Semistrap-export-{timestamp}.zip",
        ...
        {
            const string LOG_IDENT = "SemistrapViewModel::AddFilesToZipStream";
