...
namespace Semistrap.UI.ViewModels.About
{
    public class SupportersViewModel : NotifyPropertyChangedViewModel
    {
        ...
        public async void LoadSupporterData()
        {
            ...
            try
            {
                SupporterData = await Http.GetJson<SupporterData>("https://raw.githubusercontent.com/set-semi/Semistrap/main/supporters.json");
            }
            catch (Exception ex)
            {
